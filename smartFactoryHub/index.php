...
<body>
    ...
    <nav class="bg-orange-400 p-2 flex text-white justify-between items-center">
        ...
        <div class="flex justify-items-end">  
            ...
            <button class="hidden md:block bg-white text-orange-600 px-4 py-2 mr-2 rounded-lg hover:bg-gray-100 hover:shadow-black/50 hover:shadow-lg"><a href="signup.php">Daftar</a></button>
            <button class="hidden md:block bg-white text-orange-600 px-4 py-2 mr-7 rounded-lg hover:bg-gray-100 hover:shadow-black/50 hover:shadow-lg"><a href="login.php">Masuk</a></button>
